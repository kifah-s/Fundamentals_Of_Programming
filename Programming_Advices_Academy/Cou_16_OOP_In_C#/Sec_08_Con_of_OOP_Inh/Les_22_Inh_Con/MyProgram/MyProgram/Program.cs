...
public class clsEmployee : clsPerson
{
    ...
    public clsEmployee(int ID, string FirstName, string LastName, string Title, float Salary, string DepartmentName) : base(ID, FirstName, LastName, Title)
    {
        this.Salary = Salary;
...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        clsEmployee Employee1 = new clsEmployee(10, "Mr.", "Mohammed", "Abu-Hadhoud", 5000, "IT");
